...
<html>
    ...
    $entrada = 2;
                        ...
                        $buscar_saida .= "AND codigo_transporte = {$codigo_transporte} ";
                        ...
                        $buscar_entrada .= "AND codigo_transporte = {$codigo_transporte} ";
        ...
        $buscar_transportes .= "ORDER BY data_transporte DESC ";
                ...
                <div class="box">
                    <div class="row">
                        ...
                        <a href="detalhes-transportes.php?codigo=<?php echo $cod_t ?>" class="col-12 col-lg-1 noprint"><input class="btn-block" type="button" value="Ver"></a>
                    </div>
                    <div class="row col-12">
