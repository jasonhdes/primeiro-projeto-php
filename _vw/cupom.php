            ...
            <div class="box">
                <div class="row col-12">
                    ...
                    <div class="col-12 col-lg-6 right">
                        <h6>
                            Vendido por: <?php echo $nome_vendedor ?><br>
                            ...
                            Total de itens: <?php echo $resultado_venda['quantidade']; ?><br>
                            Valor total da mercadoria: <?php echo 'R$ ' . number_format($resultado_venda['valor'], 2, ',', '.'); ?>
                        </h6>
                    </div>
                </div>
